package com.palmer.framework.swagger.config;
...
import static com.palmer.framework.web.util.WebFrameworkUtils.HEADER_TENANT_ID;
...
public class PalmerSwaggerAutoConfiguration {
